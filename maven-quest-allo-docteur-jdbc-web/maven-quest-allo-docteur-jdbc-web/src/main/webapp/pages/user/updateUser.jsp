<%-- 
    Document   : updateUser
    Created on : 12 janv. 2019, 16:03:31
    Author     : TA013BE
--%>
            ...
            <section>
                <div class="content">
                    <div class="User quest">
                        ...
                        <form method="post" id="customer-info-form" class="no-gutters"  action="ManageUsersServlet">
                            <div class="account-container row">
                                ...
                                <fieldset class=" common-form-controls col-md-4">
                                    <div>
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input value="<%=request.getAttribute("firstname")%>" name="firstname" id="firstname" type="text">
                                        </div>
                                        <div class="input-wrapper">
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input id="dteNaiss" name="dteNaiss" style="width:auto;" value="<%=request.getAttribute("dteNaiss")%>" data-toggle="datepicker" type="text" name="naissance">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="col-md-4">
                                    ...
                                    <div class="input-wrapper">
                                        <label>Rue :</label>
                                        <input type="text"  name="street" value="<%=request.getAttribute("street")%>">
                                    </div>
                                    <div class="input-wrapper">
                                        <label>Code postal :</label>
                                        <input type="text" value="<%=request.getAttribute("postal_code")%>"  name="postal_code">
                                    </div>
                                    <div class="input-wrapper">
                                    ...
                                    <div class="input-wrapper">
                                        <label>Pays :</label>
                                        <input value="<%=request.getAttribute("country")%>" type="text" name="country">
                                    </div>
                                </fieldset>
                            </div>
                            <div class="row">
