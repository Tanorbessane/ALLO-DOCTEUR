...
<html class="no-js" lang=""> 
  <head>
    ...
    <link rel="stylesheet" href="/maven-allo-docteur-web/assets/styles/bootstrap.css"> 
    <link rel="stylesheet" href="/maven-allo-docteur-web/assets/styles/main.css">
    <link rel="stylesheet" href="/maven-allo-docteur-web/assets/styles/rwd.css">
    <!-- endbuild -->
  ...
  <body class="clearfix">
    ...
    <!-- bower:js -->
    <script src="/maven-allo-docteur-web/assets/scripts/jquery.js"></script>
    <!-- endbower -->
    <!-- endbuild -->
    
    <!-- build:js scripts/main.js -->
    <script src="/maven-allo-docteur-web/assets/scripts/jquery.slicknav.js"></script>
    <script src="/maven-allo-docteur-web/assets/scripts/main.js"></script>
    <!-- endbuild -->
  </body>
</html>
