                ...
                <tbody>
                   <%   if (rendezVous.isEmpty()) {
                           ...
                           for (RendezVous rdv : rendezVous) {
                               ...
                               if (rdv.getPresent() == false){
                               		out.println("<td><a href='http://localhost:8080/maven-allo-docteur-back-office-web/PresencePatientServlet?idPatient="+ rdv.getIdPatient() +"&idRendezVous="+ rdv.getIdRendezVous() +"'> present </a></td>");                               
                               }else{
