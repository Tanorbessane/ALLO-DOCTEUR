...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
       ...
       //  TODO code application logic here
		...
		/*
		 * List<Adresse> allAdresses = adresseDao.findAdressesByVille("Paris"); for
		 * (Adresse adresse : allAdresses ) { System.out.println(adresse); } Adresse
		 * trente = adresseDao.findAdresseById(84); Utilisateur userCRUD = new
		 * Utilisateur("Mr", "Jean", "Ass", "jean.ass@gmail.com", "passw0rd", new
		 * Date(System.currentTimeMillis()));
		 * System.out.println(serviceFacade.getUtilisateurDao().createUtilisateur(
		 * userCRUD));
		 ...
		 * System.out.println(adresseDao.updateAdresse(trente)); Adresse adresseCRUD =
		 * new Adresse("97 boulevard Voltaire","75011","Paris","France",
		 * userCRUD.getIdUtilisateur());
		 * System.out.println(serviceFacade.getAdresseDao().createAdresse(adresseCRUD));
		 * adresseCRUD.setCodePostal("75 000 Bis"); adresseCRUD.setVille("Paris Bis");
		 * adresseCRUD = serviceFacade.getAdresseDao().updateAdresse(adresseCRUD);
		 * adresseCRUD =
		 * serviceFacade.getAdresseDao().findAdresseById(adresseCRUD.getIdAdresse());
		 * System.out.println(serviceFacade.getUtilisateurDao().findAllUtilisateurs());
		 * System.out.println(serviceFacade.getUtilisateurDao().findUtilisateursByPrenom
		 * ("Jean"));
		 */
    }
}
